...
namespace AMKsGear.AppLayer.Core.Globalization.Persian.PersianDateTime
{
        ...
        IEquatable<PersianDate>
    {
        ...
        private void CheckYear(int YearNo)
        {
            if (YearNo < 1 || YearNo > 9999)
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidYear));
            }
        }
        ...
        private void CheckMonth(int MonthNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidMonth));
            }
        }
        ...
        private void CheckDay(int YearNo, int MonthNo, int DayNo)
        {
            if (MonthNo < 6 && DayNo > 31)
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidDay));
        ...
        private void CheckHour(int HourNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidHour));
            }
        }
        ...
        private void CheckMinute(int MinuteNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidMinute));
            }
        }
        ...
        private void CheckSecond(int SecondNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidSecond));
            }
        }
        ...
        private void CheckMillisecond(int MillisecondNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidMillisecond));
            }
        }
        ...
        public static PersianDate Parse(string value, bool includesTime)
        {
            ...
            if (includesTime)
            {
                if (value.Length > 19)
                {
                    ...
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidDateTimeLength));
                }
                ...
                {
                    throw new InvalidPersianDateFormatException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidDateFormat));
                }
                ...
                {
                    throw new InvalidPersianDateFormatException(
                    Localization.Format<IPersianDateTimeLocalization, DefaultPersianDateTimeLocalization>(x => x.InvalidTimeFormat));
                }
