...
namespace AMKsGear.AppLayer.Core.Localization.Persian.PersianDateTime
{
        ...
        IEquatable<PersianDate>
    {
        ...
        private void CheckYear(int YearNo)
        {
            if (YearNo < 1 || YearNo > 9999)
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidYear));
            }
        }
        ...
        private void CheckMonth(int MonthNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidMonth));
            }
        }
        ...
        private void CheckDay(int YearNo, int MonthNo, int DayNo)
        {
            if (MonthNo < 6 && DayNo > 31)
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidDay));
        ...
        private void CheckHour(int HourNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidHour));
            }
        }
        ...
        private void CheckMinute(int MinuteNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidMinute));
            }
        }
        ...
        private void CheckSecond(int SecondNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidSecond));
            }
        }
        ...
        private void CheckMillisecond(int MillisecondNo)
        {
            ...
            {
                throw new InvalidPersianDateException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidMillisecond));
            }
        }
        ...
        public static PersianDate Parse(string value, bool includesTime)
        {
            ...
            if (includesTime)
            {
                if (value.Length > 19)
                {
                    ...
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidDateTimeLength));
                }
                ...
                {
                    throw new InvalidPersianDateFormatException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidDateFormat));
                }
                ...
                {
                    throw new InvalidPersianDateFormatException(
                    LocalizationServices.Format<IPersianDateTimeLocalizationModel, DefaultPersianDateTimeLocalizationModel>(x => x.InvalidTimeFormat));
                }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            switch(format)
            {
                case "D":
                    ...
                    return string.Format("{0} {1} {2} {3}", new object[4] { LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year });
                    
                case "f":
                    //'hh:mm yyyy mmmm dd dddd' e.g. 'دوشنبه 20 شهریور 1384 21:30'
                    return string.Format("{0} {1} {2} {3} {4}:{5}", new object[6] { LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year, PDateTimeUtil.ToDouble(Hour), PDateTimeUtil.ToDouble(Minute) });

                case "F":
                    //'tt hh:mm:ss yyyy mmmm dd dddd' e.g. 'دوشنبه 20 شهریور 1384 02:30:22 ب.ض'
                    return string.Format("{0} {1} {2} {3} {4}:{5}:{6} {7}", new object[8] { LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year, PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), PDateTimeUtil.ToDouble(Second), designator });
                    
                case "g":
                    //'yyyy/mm/dd hh:mm tt'
                    return string.Format("{0}/{1}/{2} {3}:{4} {5}", new object[6] { Year, PDateTimeUtil.ToDouble(Month), PDateTimeUtil.ToDouble(Day), PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), designator });
                    
                case "G":
                    //'yyyy/mm/dd hh:mm:ss tt'
                    return string.Format("{0}/{1}/{2} {3}:{4}:{5} {6}", new object[7] { Year, PDateTimeUtil.ToDouble(Month), PDateTimeUtil.ToDouble(Day), PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), PDateTimeUtil.ToDouble(Second), designator });
                ...
                case "s":
                    //'yyyy-mm-ddThh:mm:ss'
                    return string.Format("{0}-{1}-{2}T{3}:{4}:{5}", Year, PDateTimeUtil.ToDouble(Month), PDateTimeUtil.ToDouble(Day), PDateTimeUtil.ToDouble(Hour), PDateTimeUtil.ToDouble(Minute), PDateTimeUtil.ToDouble(Second));
                    
                case "t":
                    //'hh:mm tt'
                    return string.Format("{0}:{1} {2}", PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), designator);
                    
                case "T":
                    //'hh:mm:ss tt'
                    return string.Format("{0}:{1}:{2} {3}", new object[4] { PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), PDateTimeUtil.ToDouble(Second), designator });

                    
                case "d":
                default:
                    //ShortDatePattern yyyy/mm/dd e.g. '1384/9/1'
                    return string.Format("{0}/{1}/{2}", Year, PDateTimeUtil.ToDouble(Month), PDateTimeUtil.ToDouble(Day));
