...
{
    public class EnumerableCrudService<TEntity, TOptions> : ICrudService<TEntity, TOptions>
        ...
        where TOptions : ICrudServiceOptions
    {
        ...
        public virtual IEnumerable<TEntity> Source { get; }

        public EnumerableCrudService(IEnumerable<TEntity> queryable)
        {
        ...
        protected virtual IEnumerable<TEntity> ApplyOptions(IEnumerable<TEntity> table, TOptions options)
        {
            return table;
        }
        ...
        public virtual IEnumerable<TSelect> GetAll<TSelect>(Expression<Func<TEntity, TSelect>> @select, TOptions options)
            => ApplyOptions(Source, options).Select(@select.Compile());

        public virtual TEntity Find(Expression<Func<TEntity, bool>> predicate, TOptions options)
            => ApplyOptions(Source, options).FirstOrDefault(predicate.Compile());
