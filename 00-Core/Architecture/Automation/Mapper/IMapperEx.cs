...
namespace AMKsGear.Architecture.Automation.Mapper
{
    ...
    {
        /// <summary>
        /// Creates a function to map an object with type of <c>srcType</c> to an object with type of <see cref="destType"/>.
        /// </summary>
        /// <param name="destType">Type of the destination object.</param>
        /// <param name="srcType">Type of the source object.</param>
        ...
        Func<object, object> GetMapFunction(Type destType, Type srcType, object[] options);
        ...
        Action<object, object> GetMapAction(Type destType, Type srcType, object[] options);
