...
namespace AMKsGear.Core.Automation
{
    ...
    #region ActivatorLazy
    public class Lazy<T> : Lazy, ILazyObjectProvider, ILazyValue<T>, ILazyValueGeneric<T>
//System.Lazy<T>, 
    {
        public Lazy()
            : base(typeof(T))
    ...
    #region TypeResolverLazy
    public class TypeResolverLazy<T> : TypeResolverLazy, ILazyObjectProvider, ILazyValue<T>, ILazyValueGeneric<T>
    {
