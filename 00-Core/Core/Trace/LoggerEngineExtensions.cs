...
//    {
//        public static void Write(this ILogChannel engine, string @string, string styles)
//        {
//            if (engine == null) throw new ArgumentNullException(nameof(engine));
//            engine.Write(@string, styles, null);
//        }
//        public static void Write(this ILogChannel engine, string @string, string styles = "", [CallerMemberName] string callerMemberName = null)
