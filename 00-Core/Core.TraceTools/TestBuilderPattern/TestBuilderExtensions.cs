...
//
//            var log = LocalizationServices.Format<ITestingLocalizationModel, DefaultTestingLocalizationModel>(
...
//            
//            var resultStr = Localization.Format<ITestingLocalizationModel, DefaultTestingLocalizationModel>(
//                result ? (Func<ITestingLocalizationModel, string>)(x => x.Successful) : (x => x.Failed));
//            
//            var log = Localization.Format<ITestingLocalizationModel, DefaultTestingLocalizationModel>(
