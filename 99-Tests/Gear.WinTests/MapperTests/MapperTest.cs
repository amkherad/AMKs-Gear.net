...
using ir.amkdp.gear.core.TraceTools;
using ir.amkdp.gear.core.TraceTools.TestBuilderPattern;

namespace Gear.WinTests.MapperTests
{
    public class MapperTest
    {
        public static void DoTest()
        {
            Test.RegisterPrivateLogger(new LocalLogger());
